                                        ...
                                        <tbody>
                                            @foreach ($scategories as $scategory)
                                                <tr>
                                                    <td>{{ $scategory->id }}</td>
                                                    <td>
                                                        <img src="{{ asset('images/categories/'.$scategory->image) }}" alt="{{ $scategory->name }}" width="60">
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="javascript:void(0)" class="ml-1" onclick="confirm('Are you sure, you want to delete this service category? ') || event.stopImmediatePropagation()"
