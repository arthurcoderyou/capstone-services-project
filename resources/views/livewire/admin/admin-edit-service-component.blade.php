                                ...
                                <div class="panel-body">
                                    ...
                                    <form action="" class="form-horizontal" wire:submit.prevent="updateService" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="inclusion" class="form-control" id="inclusion" cols="30" rows="10"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="exclusion" class="form-control" id="exclusion" cols="30" rows="10"
                                                wire:model="exclusion"
                                                ></textarea>
                                                @error('exclusion')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="file" class="form-control" name="newthumbnail" wire:model="newthumbnail">
                                                @error('newthumbnail')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                                @if($newthumbnail)
                                                    <div class="text-center py-1 my-1">
                                                        <img  style="margin-top: 10px;"
                                                            src="{{ $newthumbnail->temporaryUrl() }}" width="60" alt="" >
                                                    </div>
                                                @else

                                                    <div class="text-center py-1 my-1">
                                                        <img  style="margin-top: 10px;"
                                                            src="{{ asset('images/services/thumbnails/'.$thumbnail) }}" width="60" alt="" >
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                @else
                                                    <div class="text-center py-1 my-1">
                                                        <img  style="margin-top: 10px;"
                                                            src="{{ asset('images/services/'.$image) }}" width="60" alt="" >
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
